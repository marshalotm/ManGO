...
?>
      <p><font color = "black"><span class="glyphicon glyphicon-user"> <?php echo "สวัสดีคุณ".$_SESSION['user']; ?></span></font></p>
    	<br><br>
<?php
	}
?>
